    ...
    return (
        <div className="py-4 md:py-9 px-4 md:px-12">
            <div className='flex flex-col items-center gap-3 relative overflow-hidden rounded-xl pt-7 md:pt-12'>
                ...
                <h1 className='text-zinc-800 text-2xl md:text-4xl font-bold text-center px-4'>Access 100+ Free Animated Icons</h1>
                <p className='text-zinc-800 text-base md:w-2/3 text-center px-4'>This is a free personal project designed for the creative community, featuring 100+ animated icons made with Lottie. It will always remain free, but your support through donations would greatly help sustain the service and expand the icon pack.</p>
