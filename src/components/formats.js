    ...
    return (
        <div className='py-4 px-4 md:px-12 flex flex-col md:flex-row gap-12 my-12'>
            <div className='rounded-xl text-zinc-800 w-full md:w-1/3'>
                ...
                <p className='text-zinc-600 text-center md:text-left'>The most popular bitmap image format supporting transparency.</p>
            </div>
            <div className='rounded-xl text-zinc-800 w-full md:w-1/3'>
                <div className='flex items-center justify-center md:justify-start gap-2 mb-2'>
                ...
                <p className='text-zinc-600 text-center md:text-left'>SVG vector format allows you to customize the icon as you like.</p>
            </div>
            <div className='rounded-xl text-zinc-800 w-full md:w-1/3'>
                <div className='flex items-center justify-center md:justify-start gap-2 mb-2'>
                ...
                <p className='text-zinc-600 text-center md:text-left'>SVG-based formats designed for animated vector icons.</p>
            </div>
        </div>
    );
};
