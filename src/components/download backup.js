        ...
        <div className="fixed inset-0 bg-zinc-900 bg-opacity-80 md:flex justify-center items-center overflow-y-scroll">
            <div className="bg-white p-4 md:rounded-xl relative w-full md:w-11/12 lg:w-9/12 flex flex-col md:flex-row gap-4 overflow-y-scroll items-end md:items-stretch">
                ...
                <div className='w-full md:w-1/2 relative'>
                    <LottiePreviewDownload animationData={icon.lottie} />
                    <Link to='/how-to-use/#colors' className='flex absolute top-2 right-2 gap-2 bg-zinc-100 border-2 border-zinc-200 hover:bg-zinc-200 duration-200 items-center h-10 px-4 rounded-sm'>
                ...
                <div className='w-full md:w-1/2'>
                    ...
                    <div className="mt-4">
                        <a href={icon.lottie} download className='text-zinc-50 group bg-zinc-800 rounded-md text-base duration-500 relative overflow-hidden w-full h-12 block'>
